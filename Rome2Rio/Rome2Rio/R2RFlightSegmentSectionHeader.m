...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        CGRect rect = CGRectMake((self.bounds.size.width/2)-(joinerSize.width/2), 30, joinerSize.width, 25);
        ...
        rect = CGRectMake(0, 30, (self.bounds.size.width/2)-(joinerSize.width/2), 25);
        ...
        rect = CGRectMake((self.bounds.size.width/2)+(joinerSize.width/2), 30, (self.bounds.size.width/2)-(joinerSize.width/2), 25);
